...
export CNV_REF_DIR="/mnt/pipelines/ngs_tumor/reference/cnv"
...
export PANEL_REGIONS="/mnt/pipelines/ngs_tumor/reference/panel_v4.1_hg19.csv"
...
export INPUT_DIR="/data/ngs_tumor/input/fastq"
export VARIANTS_SEARCH_DIR="/data/ngs_tumor/input/vcf"
export RESULTS_BASE="/data/ngs_tumor/output"
export VENV_PATH="/mnt/pipelines/ngs_tumor/env"
